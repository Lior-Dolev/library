...
export const getPackagesStoriesPaths = (): string[] => {
  ...
  //   'packages'
  // );
  const packagesRootDirectoryPath: string = path.join(
    currentDirectoryPath,
    '..'
  );
  console.log('currentDirectoryPath', currentDirectoryPath);
  console.log('packagesRootDirectoryPath', packagesRootDirectoryPath);

  // const packageDirectoryNames: string[] = getDirectories(
  //   packagesRootDirectoryPath
  // );
  const packageDirectoryNames: string[] = ['stories'];
