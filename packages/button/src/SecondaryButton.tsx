...
const SecondaryButton: ForwardRefExoticComponent<ButtonProps & RefAttributes<HTMLButtonElement>> = forwardRef<
  HTMLButtonElement,
  ButtonProps
>(({ readOnly, variant, ...rest }: ButtonProps) => (
  <Button
    css={[
      secondaryBaseCSS,
      variant !== 'text' && secondaryColoredCSS,
