import { forwardRef, type ForwardRefExoticComponent, type ReactNode, type RefAttributes, useImperativeHandle, useState } from "react";
 ...
 */
const ChatFooterForm: ForwardRefExoticComponent<IChatFooterFormPropsWithRef> = forwardRef<IChatFooterFormRef, IChatFooterFormProps>(({ isLoading, onSubmit, submitTooltipContent,
  textBoxMaxRows, textBoxPlaceholder }, ref) => {
  ...
  >
    <TextField
      ...
      variant="outlined"
    />
    <SubmitMessageButton isLoading={isLoading} onClick={_onSubmit} tooltipContent={submitTooltipContent} />
  </form>
})
