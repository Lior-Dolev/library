...
const ChatFooter: ForwardRefExoticComponent<IChatFooterPropsWithRef> = forwardRef<IChatFooterFormRef, IChatFooterProps>(({ children, isLoading, onSubmit, submitTooltipContent = `שליחה`, textBoxMaxRows = 5, textBoxPlaceholder = `כתיבת הודעה` }, ref) => (
